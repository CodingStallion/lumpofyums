...
public class UserDatabase {
    ...
    public boolean saveUser(User user){
        ...
        try{
            ...
            String query = "insert into user(username, email, address, password, first_name, last_name, phone, gender,question,answer) values(?,?,?,?,?,?,?,?,?,?)";
           ...
           pt.setString(9, user.getQuestion());
           pt.setString(10, user.getAnswer());
           pt.executeUpdate();
           set = true;
        }catch(Exception e){
            e.printStackTrace();
